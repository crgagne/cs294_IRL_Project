...
class Wave1Env(gym.Env):
    ...
    def _step(self, action):
        ...
        if(len(self.crystal_locations)==0):
            end=1
    ...
    def _reset(self):
        ...
        self.ship_location = np.array([20,20],dtype=np.int) # 1
        ...
        #self.crystal_locations = np.array([(6,4),(8,9)],dtype=np.int) #3
        self.asteroid_locations = np.array([(19,19),(15,22),(22,24),(30,23),(34,21)],dtype=np.int) #4
        #self.asteroid_locations = np.array([(19,19),(15,22)],dtype=np.int) #4
